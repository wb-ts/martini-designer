...
If the string is not a number the while step will iterate it's children again if the string equals 'true'.`,
    ...
    step_prop_desc_concurrent_async: `When set to true, the children will run in a separate thread in sequence and the Gloop service will not wait for them to complete.
"When false, each child will run in it's own thread, and the Gloop service will wait for them all to complete before continuing.`,
    step_prop_desc_invoke_async:
        "When set to true, Gloop will invoke the step in a separate thread and will not wait for it to complete.",
...
This is useful for retrying an operation that sometimes may not work. When this is true, exceptions are ignored and the while step will start over.`,
    ...
    select_gloop_array_title: "Select a Gloop Property Array",
    ...
    object_prop_desc_name: "Name of the Gloop property.",
    ...
    contains characters or a sequence that renders it invalid for Gloop, then the name is sanitized for use in Gloop code
    and the alias is used when serializing to xml/json/yaml.`,
    object_prop_desc_comments: "Comments for the Gloop property.",
    ...
    object_prop_desc_array: "Set Gloop property as an array.",
    ...
    object_prop_desc_model_allow_extra_props: "Allow Gloop properties to be added to the model.",
    object_prop_desc_model_reference: "Model that the Gloop property references.",
    object_prop_desc_date_formats:
        "Gloop will use these date formats when reading data from JSON, XML, flat files, etc.",
    object_prop_desc_xml_type: "Gloop will format the data using the given selection when marshalling to XML.",
    ...
    cannot_use_gloop_keywords: "Cannot use Gloop keywords as name.",
    ...
    creating_martini_package: (name: string) => `Creating Martini package '${name}'...`,
    error_title: "Error",
    fetching_martini_packages: "Fetching Martini packages...",
    ...
    gloop_cassandra_label: "Gloop Cassandra Service",
    create_gloop_cassandra_title: "Create a Gloop Cassandra service",
    create_gloop_cassandra_description: "Create a new Gloop Cassandra service.",
    gloop_sql_label: "Gloop SQL Service",
    create_gloop_sql_title: "Create a Gloop SQL service",
    create_gloop_sql_description: "Create a new Gloop SQL service.",
    gloop_mongodb_label: "Gloop MongoDB Service",
    create_gloop_mongodb_title: "Create a Gloop MongoDB service",
    create_gloop_mongodb_description: "Create a new Gloop MongoDB service.",
    ...
    package_name_exists: "A Martini package with that name already exists.",
    ...
    endpoint_auto_start_tooltip:
        "Whether or not the endpoint should be started automatically when the Martini package is started.",
    ...
    ffd_title: "Flat File Descriptor",
    create_ffd: "Create a flat file descriptor.",
    ...
    create_gloop_model_title: "Create a new Gloop Model.",
    create_gloop_model_from_json: "Create a Gloop model from JSON.",
    create_gloop_model_from_json_schema: "Create a Gloop Model from a JSON Schema (json-schema.org).",
    create_gloop_model_from_xml: "Create a Gloop Model from XML.",
    create_gloop_model_from_xml_schema: "Create a Gloop Model from a XML Schema (.xsd).",
    create_gloop_model_from_yaml: "Create a Gloop Model from YAML.",
    ...
    schema: "Schema",
    invalid: "Invalid.",
    generating_gloop_model: "Generating Gloop model...",
    generating_gloop_models: "Generating Gloop models...",
    ...
    create_gloop_service: "Create a new Gloop service.",
    create_gloop_service_title: "Create a Gloop service",
    input: "Input",
    output: "Output",
    ...
    keyspace: "Keyspace",
    create_gloop_template: "Create a new Gloop template.",
    create_gloop_template_title: "Create a Gloop Template",
    create_gloop_template_scratch_html: "Create a Gloop template from scratch or existing HTML.",
    generate_gloop_template_from_html: "Generate a Gloop template from existing HTML.",
    ...
    generating_gloop_template: "Generating Gloop template",
    ...
    load: "Load",
    unload: "Unload",
    start_multi_packages: "Start Martini Packages",
    start_single_package: "Start Martini Package",
    start_single_package_question: name => `Start Martini package '${name}'?`,
    start_multi_packages_question: "Start the following Martini packages?",
    starting_package: "Starting Martini package",
    stop_multi_packages: "Stop Martini Packages",
    stop_single_package: "Stop Martini Package",
    stop_single_package_question: name => `Stop Martini package '${name}'?`,
    stop_multi_packages_question: "Stop the following Martini packages?",
    stopping_package: "Stopping Martini package",
    unload_multi_packages: "Unload Martini Packages",
    unload_single_package: "Unload Martini Package",
    unload_single_package_question: name => `Unload Martini package '${name}'?`,
    unload_multi_packages_question: "Unload the following Martini packages?",
    unloading_package: "Unloading Martini package",
    load_multi_packages: "Load Martini Packages",
    load_single_package: "Load Martini Package",
    load_single_package_question: name => `Load Martini package '${name}'?`,
    load_multi_packages_question: "Load the following Martini packages?",
    loading_package: "Loading Martini package",
    restart_multi_packages: "Restart Martini Packages",
    restart_single_package: "Restart Martini Package",
    restart_single_package_question: name => `Restart Martini package '${name}'?`,
    restart_multi_packages_question: "Restart the following Martini packages?",
    restarting_package: "Restarting Martini package",
    delete_multi_packages: "Delete Martini Packages",
    delete_single_package: "Delete Martini Package",
    delete_single_package_question: name => `Delete Martini package '${name}'?`,
    delete_multi_packages_question: "Delete the following Martini packages?",
    deleting_package: "Deleting Martini package",
    create_package: "Create a Martini package.",
    create_package_title: "Create a Martini Package",
    version: "Version",
    marketplace_id: "Marketplace Id",
    state_on_create: "State on Create",
    martini_package: "Martini Package",
    loaded: "Loaded",
    started: "Started",
    unloaded: "Unloaded",
    ...
    select_model_ref_title: "Select Gloop Model Reference",
    ...
    toggle_show_method_signatures: "Toggle Show Method Signatures",
    ...
    show_method_signatures: "Show Method Signatures",
    show_named_parameters: "Show Named Parameters",
    edit_label: "Edit Label",
    toggle_enabled: "Toggle Enabled",
    filters: "Filters",
    wrap_with: "Wrap With",
    failed_resolve_gloop_service: name => `Failed to resolve the Gloop service '${name}'.`,
    edit: "Edit",
    ...
    gloop_service_prop_desc_comments: "The comments for the Gloop service.",
    ...
    gloop_service_body_parameter_desc:
        "If you select POST, PUT, or PATCH, you will be allowed to set the body of your requests. The body can be any of the Gloop service's inputs.",
    gloop_service_url_path_desc:
        "Enter the path you want to use for accessing the service. You can set an input property (except Gloop models and objects) as a path parameter by enclosing it with {}.",
